...
def check_and_truncate(conversationArray):
    ...
    if len(joined_context) > 25000:
        ...
        return check_and_truncate(conversationArray)  # Recursively call until the condition is false
...
def show_issue(issue_text):
    ...
    issue_prompt += f"{issue_text}\nNow I will send you some code so that we can find the part"
    issue_prompt += " that is likely causing the issue mentioned above. Please let me know if"
    issue_prompt += " you are ready."
